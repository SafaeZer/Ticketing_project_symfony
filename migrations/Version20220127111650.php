 ...
 */
final class Version20220127111650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE status_id status_id INT NOT NULL, CHANGE files files VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket CHANGE status_id status_id INT DEFAULT NULL, CHANGE files files VARBINARY(500) NOT NULL');
    }
}
