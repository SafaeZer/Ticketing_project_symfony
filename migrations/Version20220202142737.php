 ...
 */
final class Version20220202142737 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD status_id INT NOT NULL, CHANGE files files VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP status_id, CHANGE files files VARBINARY(500) NOT NULL');
    }
}
